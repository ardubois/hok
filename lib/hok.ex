defmodule Hok do
  ...
  defmacro hok(function) do
   ...
   defmacro gpufor({:<-,_, [{var1, _, nil}, {:..,_, [b1, e1]}]}, {arr1,_,nil}, {:<-,_, [{var2, _, nil}, {:..,_, [b2, e2]}]},{arr2,_,nil},do: body) do
       r=      quote do: MM.comp2xy2D(unquote({arr1,_,nil}), unquote({arr2,_,nil}), unquote(e1), unquote(e2),
